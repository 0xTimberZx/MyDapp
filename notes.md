...
- [x] Day 2 - Deployed smart contract
- [x] Day 3 - Build frontend
- [x] Day 4 - Go live with GitHub Pages
- [x] Day 5 - Successfully connected wallet, read & wrote to blockchain
...
- ETH balance display + refresh ✅
- Current message loads on connect ✅
- Update message with gas estimation ✅
- Transaction history with retry logic ✅
- Filter history by wallet address ✅
- Clear filter ✅
- Arbiscan links ✅
- Works on MetaMask mobile ✅
- Works on Brave tablet ✅
...
- StringCompiler(old) : 0x4795dae318574cAa3C54c79c50e2ac3eb5c3a838 
